...
Prompts for testing that the `band-research` skill triggers correctly
and produces the expected output.

## Should Trigger

These prompts should activate the `band-research` skill.
...
These prompts should NOT activate the `band-research` skill.
